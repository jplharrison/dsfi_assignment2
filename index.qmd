...
To gain a depper understading of the change in sentiment over timie for each given president and their speeches we can look to figure XXX in the appendix. While the plot dos provide a granular insight into the overall sentiment behaviour of each sentence for president's the volume and lack of discernable trend makes the plot difficult to interpret without segnmenting the speeches into larger periods. 
...
Figure XXX plots the distribution of sentiment scores for each president.
For de Klerk, there's a noticeable tilt towards neutral to negative sentiments, suggesting that discussions about him might often carry a more critical tone. On the other hand, Mandela's mentions are predominantly positive, indicating a narrative rich in appreciation or admiration. Mbeki's sentiment profile reveals an overwhelmingly positive tone, with many statements leaning towards commendation. Motlanthe's mentions also predominantly exhibit positivity, especially between the 0.50 to 1.00 range, highlighting a general positive narrative about him. Zuma presents a diverse sentiment spectrum; while there's a substantial representation in the positive range, especially towards the higher end, there's also a notable amount of negative sentiment. This suggests a mixture of both commendatory and critical views about Zuma. Lastly, discussions about Ramaphosa are mostly tinted with positivity, particularly around the 0.50 to 0.75 range, although some neutral and negative sentiments are present. Overall, while Mandela, Mbeki, Motlanthe, Zuma, and Ramaphosa's mentions lean more towards positivity, de Klerk's profile hints at a more neutral with a tilt towards negativity. It's imperative to remember that these sentiment scores represent the tone of the sentences and not necessarily the public's perception.
