...
```{python}
#| echo: False
#| fig-cap: "Figure x: Mean Sentiment Scores per President"
...
```{python}
#| echo: false
#| fig-cap: "Figure x: Sentiment Distribution per President"
...
#| echo: false
#| eval: true
#| fig-cap: "Figure x: Distribution of Sentiment Scores for each President"
...
```{python}
#| echo: false
#| fig-cap: "Figure 2: RoBERTa 1 Mean Sentiment Scores per President"
...
```{python}
#| echo: false
#| fig-cap: "Figure 5: RoBERTa 2 Mean Sentiment Scores per President "
...
```{python}
#| echo: false
#| fig-cap: "Figure 6: RoBERTa 2 Sentiment Distribution per President"
colors = {'Negative': '#FF9999', 'Neutral': '#99CCFF', 'Positive': '#99FF99'}
